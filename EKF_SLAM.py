...
MAX_RANGE = 400000.0  # maximum observation range
...
def calc_input(motor_data, motor_angle):
    """
    Calculates the driven distance and angle of the robot dependent on the motor data calculated in DataManager
